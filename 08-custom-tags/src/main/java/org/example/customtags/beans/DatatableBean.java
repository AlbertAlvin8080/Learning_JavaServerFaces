package org.example.customtags.beans;

import jakarta.faces.application.FacesMessage;
import jakarta.faces.context.FacesContext;
import jakarta.faces.view.ViewScoped;
import jakarta.inject.Named;
import org.example.customtags.student.Student;
...
//        System.out.println(event.getObject());
    ...
    public void save() {
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("E-mail saved", student.getEmail()));
    }

    public void save2() {
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Student saved", student.toString()));
    }
